...
import { abcPatients } from "../patientProfile/abcPatients";
   ...
   return (
      <div>
         ...
         <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-6 bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
            ...
            <div className="bg-white max-w-4xl w-full mx-auto shadow-lg rounded-2xl pt-6">
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700 w-full">
                  <p className="flex flex-wrap gap-4">
                     <span className="font-semibold">Patient ID:</span> {selectedPatient.id}
                     <span className="font-semibold ">Age:</span> {selectedPatient.age}
                     <span className="font-semibold">Gender:</span> {selectedPatient.gender}
                  </p>
                  <p className="flex flex-wrap gap-4">
                     <span className="font-semibold">Marital Status:</span> {selectedPatient.marital_status}
                     <span className="font-semibold">Religion:</span> {selectedPatient.religion}
                  </p>
                  <p className="flex flex-wrap gap-4">
                     <span className="font-semibold">Mobile:</span> {selectedPatient.mobile_number}
                     <span className="font-semibold">Address:</span> {selectedPatient.address_line_one}
                  </p>
               </div>
            </div>
                     ...
                     <Card className="mt-4 w-full">
                        <CardContent className="p-4 sm:p-6 overflow-x-auto">
                           <div className="flex flex-col space-y-2 w-full">
                              ...
                              {openMedicalInfo && (
                                 <div className="bg-white p-3 sm:p-4 rounded-xl shadow mt-2 overflow-x-auto">
                                    <h2 className="font-semibold text-green-600 mb-4 text-lg">Medical Info</h2>
                                    <table className="min-w-full border border-gray-200 text-sm sm:text-base">
                              ...
                              {openInvestigationInfo && (
                                 <div className="bg-white p-3 sm:p-4 rounded-xl shadow mt-2 overflow-x-auto">
                                    <h2 className="font-semibold text-blue-600 mb-4 text-lg">Investigation</h2>
                                    <table className="min-w-full border border-gray-200 text-sm sm:text-base">
